...
def groupchatscreen(request, code):
    try:
        group = Groups.objects.get(groupcode=code)
        try:
        ...
        return render(request, 'socialmedia/nogroup.html', {'obj': "no group with code " + code + ' found'})
...
def creategroup(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'socialmedia/nogroup.html', {'obj': form.errors})
